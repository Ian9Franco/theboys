...
export const secundarios: CharacterDetail[] = [
  ...
  },
  {
    ...
    category: 'secundarios',
    isSecondary: true,
    image: '/personajes/PORTADAS/Broly/Broly.webp',
    fullBody: '/personajes/PORTADAS/Broly/Broly.webp',
    color: '#6b7280',
    role: 'Nuevo Personaje',
    visualCode: 'Descripción visual base',
    perfil: [
  ...
  },
  {
    ...
    category: 'secundarios',
    isSecondary: true,
    image: '/personajes/PORTADAS/Deadshot/Deadshot.webp',
    fullBody: '/personajes/PORTADAS/Deadshot/Deadshot.webp',
    color: '#6b7280',
    role: 'Nuevo Personaje',
    visualCode: 'Descripción visual base',
    perfil: [
  ...
  },
  {
    ...
    category: 'secundarios',
    isSecondary: true,
    image: '/personajes/PORTADAS/Pirata Capitan/Pirata Capitan.webp',
    fullBody: '/personajes/PORTADAS/Pirata Capitan/Pirata Capitan.webp',
    color: '#6b7280',
    role: 'Nuevo Personaje',
    visualCode: 'Descripción visual base',
    perfil: [
  ...
  {
    id: 'pistolero_galactico',
    name: 'Pistolero galactico',
    category: 'secundarios',
    isSecondary: true,
    image: '/personajes/PORTADAS/Pistolero galactico/Pistolero galactico.webp',
    fullBody: '/personajes/PORTADAS/Pistolero galactico/Pistolero galactico.webp',
    color: '#6b7280',
    role: 'Nuevo Personaje',
    visualCode: 'Descripción visual base',
    perfil: [
