...
export const entidades: CharacterDetail[] = [
  ...
  },
  {
    ...
    category: 'entidades',
    isSecondary: true,
    image: '/personajes/PORTADAS/Doom/Doom.webp',
    fullBody: '/personajes/PORTADAS/Doom/Doom.webp',
    color: '#6b7280',
  ...
  },
  {
    ...
    category: 'entidades',
    isSecondary: true,
    image: '/personajes/PORTADAS/Queen of Pain/Queen of Pain.webp',
    fullBody: '/personajes/PORTADAS/Queen of Pain/Queen of Pain.webp',
    color: '#6b7280',
    role: 'Nuevo Personaje',
    visualCode: 'Descripción visual base',
    perfil: [
  ...
  },
  {
    ...
    category: 'entidades',
    isSecondary: true,
    image: '/personajes/PORTADAS/Venganza/Venganza.webp',
    fullBody: '/personajes/PORTADAS/Venganza/Venganza.webp',
    color: '#6b7280',
    role: 'Nuevo Personaje',
    visualCode: 'Descripción visual base',
    perfil: [
